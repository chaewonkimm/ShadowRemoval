...
from networks.UNet_arch import UNet
...
parser.add_argument('--training_path', type=str, default='../ntire2025_sh_rem_train', help='Training images folder')
...
if __name__ == '__main__':
    ...
    if args.Flag_multi_scale:
        net_1 = UNet(n_channels=args.img_channel, n_classes=args.img_channel)
    else:
        net_1 = UNet(n_channels=args.img_channel, n_classes=args.img_channel)
    ...
    while global_iter < args.iteration_target:
        ...
        for i, train_data in enumerate(tqdm(train_loader, desc="Training", leave=True), 0):
